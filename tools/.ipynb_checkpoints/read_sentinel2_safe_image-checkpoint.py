...
def read_s2(safe,imageCollectionName):
    ...
    #===> not used, instead we manually introduced boa_add_offset and qualification values into dictionaries SL2P
    ...
    for band in netOptions['inputBands']:
        print(band)
        s2[band]=(s2[band]+netOptions['inputOffset'][band])*netOptions['inputScaling'][band]
